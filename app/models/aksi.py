...
class AksiRecord(Base):
    """One Menu Aksi session — Pillar 8 "Kolaborasi Interprofesional"
    (6 items scored 0–3, stored as JSONB)."""

    __tablename__ = "aksi_records"

    aksi_id: Mapped[uuid.UUID] = mapped_column(
